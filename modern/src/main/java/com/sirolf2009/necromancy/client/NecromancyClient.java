...
import com.sirolf2009.necromancy.client.screen.ScreenOperationTable;
...
public final class NecromancyClient {
    ...
    public static void registerScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(NecromancyMenus.BODYPART_DEV.get(), ScreenBodypartDev::new);
        event.register(NecromancyMenus.OPERATION_TABLE.get(), ScreenOperationTable::new);
    }
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(NecromancyEntities.BODYPART_PREVIEW.get(), BodypartPreviewRenderer::new);
