...
import com.sirolf2009.necromancy.multipart.broadphase.MultipartBroadphaseTickSubscriber;
/**
...
public final class NecromancyEvents {
    ...
    public static void register() {
        ...
        NeoForge.EVENT_BUS.register(MultipartBroadphaseTickSubscriber.class);
        ...
        NeoForge.EVENT_BUS.addListener((RegisterCommandsEvent ev) -> {
            ...
            com.sirolf2009.necromancy.command.CommandNecromancyDissectStub.register(ev);
        });
    }
}
