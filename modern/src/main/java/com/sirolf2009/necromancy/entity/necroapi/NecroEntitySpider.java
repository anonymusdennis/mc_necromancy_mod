...
public class NecroEntitySpider extends NecroEntityBase implements ISaddleAble {
    ...
    @Override public LocomotionProfile locomotion() { return LocomotionProfile.walk(1.15F, SoundEvents.SPIDER_STEP); }
    @Override public VoiceProfile voice() { return VoiceProfile.SPIDER; }
