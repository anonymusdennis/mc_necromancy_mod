...
public class NecroEntityCreeper extends NecroEntityBase {
    ...
    @Override public LocomotionProfile locomotion() { return LocomotionProfile.walk(0.95F, SoundEvents.GRASS_STEP); }
    @Override public VoiceProfile voice() { return VoiceProfile.CREEPER; }
