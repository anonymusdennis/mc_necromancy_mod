...
public final class NecromancyEntities {
    ...
    public static final Supplier<EntityType<EntityBodypartPreview>> BODYPART_PREVIEW =
        ENTITIES.register("bodypart_preview",
            () -> EntityType.Builder.<EntityBodypartPreview>of(EntityBodypartPreview::new, MobCategory.MISC)
                .sized(0.6F, 1.2F)
                .clientTrackingRange(10)
                .updateInterval(1)
                .build("bodypart_preview"));
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(BODYPART_PREVIEW.get(), Mob.createMobAttributes().build());
    }
