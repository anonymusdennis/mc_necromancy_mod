...
{
    public EntityNightCrawler(World world)
    {
        super(world);
        setSize(0.6F, 1.8F);
    ...
    {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("mob.zombie.say"));
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source)
    {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("mob.zombie.hurt"));
    }

    @Override
    protected SoundEvent getDeathSound()
    {
        return SoundEvent.REGISTRY.getObject(new ResourceLocation("mob.zombie.death"));
    }
}
